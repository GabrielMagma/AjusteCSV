    ...
    public class ExcelCSVCompensacionesEEPServices : IExcelCSVCompensacionesEEPServices
    {
        ...
        public ResponseQuery<string> Convert(ResponseQuery<string> response)
        {
            try
            {
                ...
                string inputFolder = $"C:\\Users\\ingen\\source\\repos\\LecturaCSV\\LecturaCSV\\FilesCompensacionesEEP";
                ...
                for (int row = 2; row <= worksheet.Dimension.End.Row; row++)
                {
                    ...
                    if (date != "")
                    {
                        ...
                        if (!date.Contains("Error"))
                        {
                            ...
                            newRow[0] = dateDef[1];
                            newRow[1] = dateDef[2];
                            newRow[2] = worksheet.Cells[row, 6].Text != "" ? worksheet.Cells[row, 6].Text.ToUpper() : string.Empty;
